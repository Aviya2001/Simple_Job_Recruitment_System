...
<head>
  <meta charset="UTF-8" />
  <title>Admin Applicant Manage</title>
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Applicant Manage</span>
      </div>
    </nav>
    ...
    <main>
            ...
            <div class="cards_heading cards_color">
                ...
                <div class="abc"><?php echo $row['email'];?></div>
                <div class="abc"><?php echo $row['telephone'];?></div>
                <div>
                    <center> <a href="?deleteA=<?php echo $row['username'];?>"> <button class="btnview" >Delete</button> </a></center>
                 </div>
    </div>
    <?php } ?>
        </main>
